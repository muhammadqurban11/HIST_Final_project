<nav class="navbar navbar-expand-lg bg-body-tertiary">
	  <div class="container-fluid" style="background-color: #80897b">
		...
		<div class="dropdown">
			...
			<button> <a href="http://localhost/EvenigIndex.php/19839%20final_project/Day--6/login.php"style="background-color: #80897b">Login</a></button>
		    <br>
			<a href="http://localhost/EvenigIndex.php/19839%20final_project/Day--6/registeration.php"style="background-color: #80897b"> Register</a> 
