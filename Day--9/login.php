...
<div class="col-12">
	  ...
	  <br>
	  <div class="col-12">
	    <button class=" btn btn-primary" type="submit" style="background-color: skyblue; text-decoration-color: white;"> <a href="http://localhost/EvenigIndex.php/19839%20final_project/Day--6/forget_password.php">Forget Password </a></button>
	  </div>
	</form>
</center>
