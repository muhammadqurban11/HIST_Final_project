<nav class="navbar navbar-expand-lg bg-body-tertiary">
	  <div class="container-fluid" style="background-color: #80897b">
		...
		<div class="dropdown">
			...
			<button> <a href="http://localhost/index.php/Final%20Project/Day%20Vise%20Backup/Day--7/login.php" style="background-color: #80897b">Login</a></button>
		    <br>
			<button><a href="http://localhost/index.php/Final%20Project/Day%20Vise%20Backup/Day--7/registeration.php" style="background-color: #80897b"> Register</a></button> 
